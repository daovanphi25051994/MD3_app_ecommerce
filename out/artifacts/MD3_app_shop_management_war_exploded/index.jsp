...
<%@ page import="model.database.DBItem" %><%--
...
<div class="container-fluid">
    ...
    <header class="header row">
        ...
        <div class="col-xl-4"><span class="user-name" style="line-height: 90px;color: #eb6d6c">${message}${userName}</span></div>
    ...
    <div class="about">
        <h2>ABOUT</h2>
        <div><img width="1150px" height="170px" src="https://2.bp.blogspot.com/--DLlnIxlfYM/VmKw9ScsdyI/AAAAAAAAADY/-9lNdSVvQYU/s1600-r/fashion-banner-5.gif" alt=""></div>
